...
public class Assignment1 {
	...
	public void testHeader1() {
		home.clickCustomer();
		String ActualHeader1= addCustomer.getheader1(By.xpath("//span[@id='header']//a[@href='index.html']"));
...
//		addCustomer.clickDone();
		...
		String ActualHeader2= addCustomer.getheader1(By.xpath("//section[@id='main']/div[@class='inner']//h1[.='Add Customer']"));
